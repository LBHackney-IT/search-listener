...
namespace HousingSearchListener.V1.Infrastructure
{
    ...
    public class AccountDbEntity
    {
        ...
        [DynamoDBProperty(AttributeName = "consolidated_charges", Converter = typeof(DynamoDbObjectListConverter<Domain.Account.ConsolidatedCharge>))]
        public IEnumerable<Domain.Account.ConsolidatedCharge> ConsolidatedCharges { get; set; }
